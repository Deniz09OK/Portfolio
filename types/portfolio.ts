...
export const portfolio: Portfolio = {
  fr: {    nav: { roster: "Fiche", matches: "Card de la saison", career: "Saisons jouées", drills: "Entraînement quotidien", off: "Hors du clavier", languages: "Trois langues", contact: "Sifflet final" },
    ...
    hero: {
      ...
      kanji: "戦",
      stats: [
        { label: "MATCHS JOUÉS", value: "10", sub: "projets livrés" },
    ...
    matches: {
      ...
      sub: "Dix matchs joués. Dix façons de gagner."
    },
    projects: [
      { idx: "01", name: "Veille DevSecOps IA", kanji: "哨戒", type: "Agent IA & RAG", stack: "PYTHON · GROQ · CHROMADB · GITHUB ACTIONS", year: "2026", opponent: "OFFRES NOYÉES DANS LE BRUIT", verdict: "VEILLE AUTONOME 24/7", desc: "Agent IA autonome qui traque les offres d'alternance DevSecOps/Cloud (API France Travail + scraping multi-plateformes), les filtre par zone et type de contrat, puis les note via IA avec mémoire vectorielle RAG. Pipeline 100% GitHub Actions, alertes Discord, rapport Excel quotidien.", link: "https://github.com/Deniz09OK/veille-devsecops-ia" },
      { idx: "02", name: "Linux System Inventory", kanji: "監査", type: "Outil système", stack: "PYTHON · LINUX · VAGRANT", year: "2026", opponent: "PARC LINUX HÉTÉROGÈNE", verdict: "AUDIT AUTOMATISÉ", desc: "Outil d'inventaire système pour Linux automatisant la collecte d'informations matérielles et logicielles. Génère un rapport exploitable du parc.", link: "https://github.com/Deniz09OK/Linux-System-Inventory-Tool" },
      { idx: "03", name: "MediSync", kanji: "健康", type: "Plateforme santé", stack: "VUE.JS · NODE.JS · API REST", year: "2025", opponent: "OBSERVANCE INVISIBLE", verdict: "SUIVI PATIENT OBJECTIF", desc: "Plateforme de santé connectée reliant l'observance médicamenteuse au vécu réel du patient. Offre aux médecins une prise en charge personnalisée basée sur des données objectives du quotidien.", link: "https://github.com/Deniz09OK/MediSync" },
      { idx: "04", name: "GoCrew", kanji: "旅団", type: "App web collaborative", stack: "JAVASCRIPT · WEB · TEMPS RÉEL", year: "2025", opponent: "VOYAGE DE GROUPE DÉSORGANISÉ", verdict: "ORGANISATION CENTRALISÉE", desc: "Application web collaborative réalisée en équipe pour le projet de fin d'année de la Pré-MSc à Epitech. Centralise l'organisation de voyages en groupe dans une interface unique et intuitive.", link: "https://github.com/Deniz09OK/GoCrew" },
      { idx: "05", name: "NSA — Network Security", kanji: "結界", type: "Infrastructure réseau", stack: "OPENBSD · FREEBSD", year: "2025", opponent: "RÉSEAU NON SEGMENTÉ", verdict: "PASSERELLE SÉCURISÉE", desc: "Infrastructure réseau sécurisée sous OpenBSD et FreeBSD. Configuration d'une passerelle segmentant trois réseaux privés.", link: null },
      { idx: "06", name: "Popeye", kanji: "船団", type: "Conteneurisation", stack: "DOCKER · MICROSERVICES", year: "2025", opponent: "MONOLITHE WEB", verdict: "ARCHITECTURE MODULAIRE", desc: "Projet de conteneurisation avec Docker. Application web complète en architecture microservices, communication inter-services et persistance.", link: "https://github.com/Deniz09OK/Popeye" },
      { idx: "07", name: "Portfolio", kanji: "書庫", type: "Site personnel", stack: "NUXT · VUE · TAILWIND", year: "2025", opponent: "PAGE BLANCHE", verdict: "VITRINE ÉVOLUTIVE", desc: "Refonte 2026 du portfolio. Design éditorial mêlant cybersécurité et culture sportive/japonaise. Storytelling au scroll, multilingue FR/EN/TR, dark & light, fiche joueur en hero.", link: "https://github.com/Deniz09OK/Portfolio" },
      { idx: "08", name: "CultureQuiz", kanji: "知識", type: "App desktop", stack: "PYTHON · TKINTER · GUI", year: "2024", opponent: "ENNUI", verdict: "QUIZ INTERACTIF", desc: "Application de quiz interactif en Python avec interface Tkinter. Base de questions extensible, scoring, timer par manche.", link: "https://github.com/Deniz09OK/CultureQuiz" },
      { idx: "09", name: "AI-Morpion", kanji: "戦略", type: "Jeu · IA", stack: "PYTHON · MINIMAX · ALPHA-BETA", year: "2024", opponent: "JOUEUR HUMAIN", verdict: "IA INVINCIBLE", desc: "Version moderne du Tic-Tac-Toe avec une IA avancée utilisant l'algorithme Minimax. Élagage alpha-beta : l'IA ne perd jamais.", link: "https://github.com/Deniz09OK/AI-Morpion" },
      { idx: "10", name: "EpiQuest", kanji: "冒険", type: "Jeu vidéo 2D", stack: "JAVA · LIBGDX · GAMEDEV", year: "2024", opponent: "MOTEUR VIDE", verdict: "PLATFORMEUR JOUABLE", desc: "Jeu d'aventure 2D développé avec Java et LibGDX. Système de combat, dialogues, progression. Projet équipe.", link: "https://github.com/Deniz09OK/Projet-Jeu-Java" }
    ],
    career: {
  ...
  en: {
    ...
    hero: {
      ...
      kanji: "戦",
      stats: [
        { label: "MATCHES PLAYED", value: "10", sub: "shipped projects" },
    ...
    matches: { title: "Season card", sub: "Ten matches played. Ten ways to win." },
    projects: [
      { idx: "01", name: "Veille DevSecOps IA", kanji: "哨戒", type: "AI agent & RAG", stack: "PYTHON · GROQ · CHROMADB · GITHUB ACTIONS", year: "2026", opponent: "LISTINGS DROWNED IN NOISE", verdict: "AUTONOMOUS WATCH 24/7", desc: "Autonomous AI agent tracking DevSecOps/Cloud work-study job listings (France Travail API + multi-platform scraping), filtering by location and contract type, then scoring them with AI backed by a RAG vector memory. 100% GitHub Actions pipeline, Discord alerts, daily Excel report.", link: "https://github.com/Deniz09OK/veille-devsecops-ia" },
      { idx: "02", name: "Linux System Inventory", kanji: "監査", type: "System tool", stack: "PYTHON · LINUX · VAGRANT", year: "2026", opponent: "MIXED LINUX FLEET", verdict: "AUTOMATED AUDIT", desc: "Linux system inventory tool automating hardware and software information collection. Generates a usable fleet report.", link: "https://github.com/Deniz09OK/Linux-System-Inventory-Tool" },
      { idx: "03", name: "MediSync", kanji: "健康", type: "Health platform", stack: "VUE.JS · NODE.JS · REST API", year: "2025", opponent: "INVISIBLE ADHERENCE", verdict: "OBJECTIVE PATIENT TRACKING", desc: "Connected health platform linking medication adherence to the patient's actual daily life. Gives doctors personalised care based on objective everyday data.", link: "https://github.com/Deniz09OK/MediSync" },
      { idx: "04", name: "GoCrew", kanji: "旅団", type: "Collaborative web app", stack: "JAVASCRIPT · WEB · REAL-TIME", year: "2025", opponent: "DISORGANISED GROUP TRIP", verdict: "CENTRALISED ORGANISATION", desc: "Collaborative web app built as a team for the Pré-MSc end-of-year project at Epitech. Centralises group trip organisation in a single, intuitive interface.", link: "https://github.com/Deniz09OK/GoCrew" },
      { idx: "05", name: "NSA — Network Security", kanji: "結界", type: "Network infra", stack: "OPENBSD · FREEBSD", year: "2025", opponent: "FLAT NETWORK", verdict: "SECURE GATEWAY", desc: "Secure network infrastructure on OpenBSD and FreeBSD. Gateway segmenting three private networks.", link: null },
      { idx: "06", name: "Popeye", kanji: "船団", type: "Containerization", stack: "DOCKER · MICROSERVICES", year: "2025", opponent: "WEB MONOLITH", verdict: "MODULAR ARCH.", desc: "Docker containerization project. Full web app in microservices architecture, inter-service comms and persistence.", link: "https://github.com/Deniz09OK/Popeye" },
      { idx: "07", name: "Portfolio", kanji: "書庫", type: "Personal site", stack: "NUXT · VUE · TAILWIND", year: "2025", opponent: "BLANK PAGE", verdict: "LIVING SHOWCASE", desc: "2026 redesign. Editorial design blending cybersecurity with sports/Japanese culture. Scroll storytelling, FR/EN/TR i18n, dark & light, player card hero.", link: "https://github.com/Deniz09OK/Portfolio" },
      { idx: "08", name: "CultureQuiz", kanji: "知識", type: "Desktop app", stack: "PYTHON · TKINTER · GUI", year: "2024", opponent: "BOREDOM", verdict: "INTERACTIVE QUIZ", desc: "Interactive Python quiz app with Tkinter interface. Extensible question base, scoring, round timer.", link: "https://github.com/Deniz09OK/CultureQuiz" },
      { idx: "09", name: "AI-Morpion", kanji: "戦略", type: "Game · AI", stack: "PYTHON · MINIMAX · ALPHA-BETA", year: "2024", opponent: "HUMAN PLAYER", verdict: "UNBEATEN AI", desc: "Modern Tic-Tac-Toe with advanced AI using the Minimax algorithm. Alpha-beta pruning — the AI never loses.", link: "https://github.com/Deniz09OK/AI-Morpion" },
      { idx: "10", name: "EpiQuest", kanji: "冒険", type: "2D video game", stack: "JAVA · LIBGDX · GAMEDEV", year: "2024", opponent: "EMPTY ENGINE", verdict: "PLAYABLE PLATFORMER", desc: "2D adventure game developed with Java and LibGDX. Combat system, dialogue, progression. Team project.", link: "https://github.com/Deniz09OK/Projet-Jeu-Java" }
    ],
  ...
  tr: {
    ...
    hero: {
      ...
      kanji: "戦",
      stats: [
        { label: "OYNANAN MAÇ", value: "10", sub: "teslim proje" },
    ...
    matches: { title: "Sezon kartı", sub: "On maç oynandı. On kazanma yolu." },
    projects: [
      { idx: "01", name: "Veille DevSecOps IA", kanji: "哨戒", type: "YZ ajanı & RAG", stack: "PYTHON · GROQ · CHROMADB · GITHUB ACTIONS", year: "2026", opponent: "GÜRÜLTÜYE BOĞULMUŞ İLANLAR", verdict: "7/24 OTONOM TARAMA", desc: "DevSecOps/Cloud yarı zamanlı iş ilanlarını (France Travail API + çoklu platform scraping) izleyen, konum ve sözleşme türüne göre filtreleyen, ardından RAG vektör hafızasıyla YZ üzerinden puanlayan otonom ajan. %100 GitHub Actions hattı, Discord uyarıları, günlük Excel raporu.", link: "https://github.com/Deniz09OK/veille-devsecops-ia" },
      { idx: "02", name: "Linux System Inventory", kanji: "監査", type: "Sistem aracı", stack: "PYTHON · LINUX · VAGRANT", year: "2026", opponent: "KARIŞIK LINUX FİLOSU", verdict: "OTOMATİK DENETİM", desc: "Donanım ve yazılım bilgilerinin toplanmasını otomatikleştiren Linux sistem envanteri aracı. Kullanılabilir bir filo raporu oluşturur.", link: "https://github.com/Deniz09OK/Linux-System-Inventory-Tool" },
      { idx: "03", name: "MediSync", kanji: "健康", type: "Sağlık platformu", stack: "VUE.JS · NODE.JS · REST API", year: "2025", opponent: "GÖRÜNMEZ TEDAVİ UYUMU", verdict: "NESNEL HASTA TAKİBİ", desc: "İlaç uyumunu hastanın gerçek günlük yaşamına bağlayan bağlantılı sağlık platformu. Doktorlara günlük nesnel verilere dayalı kişiselleştirilmiş bakım sunar.", link: "https://github.com/Deniz09OK/MediSync" },
      { idx: "04", name: "GoCrew", kanji: "旅団", type: "İş birlikçi web uygulaması", stack: "JAVASCRIPT · WEB · GERÇEK ZAMANLI", year: "2025", opponent: "DÜZENSİZ GRUP SEYAHATİ", verdict: "MERKEZİ ORGANİZASYON", desc: "Epitech'te Pré-MSc yıl sonu projesi olarak ekip hâlinde geliştirilen iş birlikçi web uygulaması. Grup seyahati organizasyonunu tek ve sezgisel bir arayüzde merkezileştirir.", link: "https://github.com/Deniz09OK/GoCrew" },
      { idx: "05", name: "NSA — Network Security", kanji: "結界", type: "Ağ altyapısı", stack: "OPENBSD · FREEBSD", year: "2025", opponent: "DÜZ AĞ", verdict: "GÜVENLİ GEÇİT", desc: "OpenBSD ve FreeBSD üzerinde güvenli ağ altyapısı. Üç özel ağı segmentleyen ağ geçidi yapılandırması.", link: null },
      { idx: "06", name: "Popeye", kanji: "船団", type: "Konteynerleştirme", stack: "DOCKER · MİKROSERVİS", year: "2025", opponent: "WEB MONOLİT", verdict: "MODÜLER MİMARİ", desc: "Docker konteynerleştirme projesi. Mikroservis mimarisinde tam web uygulaması, servisler arası iletişim ve kalıcılık.", link: "https://github.com/Deniz09OK/Popeye" },
      { idx: "07", name: "Portfolio", kanji: "書庫", type: "Kişisel site", stack: "NUXT · VUE · TAILWIND", year: "2025", opponent: "BOŞ SAYFA", verdict: "YAŞAYAN VİTRİN", desc: "Portfolyonun 2026 yeniden tasarımı. Siber güvenlik ile spor/Japon kültürünü harmanlayan editöryel tasarım. Scroll storytelling, FR/EN/TR çoklu dil, koyu & açık, hero'da oyuncu kartı.", link: "https://github.com/Deniz09OK/Portfolio" },
      { idx: "08", name: "CultureQuiz", kanji: "知識", type: "Masaüstü", stack: "PYTHON · TKINTER · GUI", year: "2024", opponent: "SIKINTI", verdict: "İNTERAKTİF QUIZ", desc: "Tkinter arayüzü ile Python'da interaktif bilgi yarışması uygulaması. Genişletilebilir soru tabanı, puanlama, tur zamanlayıcı.", link: "https://github.com/Deniz09OK/CultureQuiz" },
      { idx: "09", name: "AI-Morpion", kanji: "戦略", type: "Oyun · YZ", stack: "PYTHON · MINIMAX · ALPHA-BETA", year: "2024", opponent: "İNSAN OYUNCU", verdict: "YENİLMEZ YZ", desc: "Minimax algoritması kullanan gelişmiş YZ ile modern Tic-Tac-Toe. Alfa-beta budama — YZ asla kaybetmez.", link: "https://github.com/Deniz09OK/AI-Morpion" },
      { idx: "10", name: "EpiQuest", kanji: "冒険", type: "2D video oyunu", stack: "JAVA · LIBGDX · OYUN", year: "2024", opponent: "BOŞ MOTOR", verdict: "OYNANABİLİR PLATFORMER", desc: "Java ve LibGDX ile geliştirilmiş 2D macera oyunu. Savaş sistemi, diyalog, ilerleme. Takım projesi.", link: "https://github.com/Deniz09OK/Projet-Jeu-Java" }
    ],

...
export const translations = {
  fr: {
    ...
    portfolio: {
      ...
      linuxSystemInventoryDesc: 'Outil d\'inventaire système pour Linux automatisant la collecte d\'informations matérielles et logicielles.',
  ...
  en: {
    ...
    portfolio: {
      ...
      linuxSystemInventoryDesc: 'System inventory tool for Linux automating the collection of hardware and software information.',
  ...
  tr: {
    ...
    portfolio: {
      ...
      linuxSystemInventoryDesc: 'Donanım ve yazılım bilgilerinin toplanmasını otomatikleştiren Linux sistem envanteri aracı.',

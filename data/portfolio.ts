...
export const portfolio: Portfolio = {
  fr: {    nav: { roster: "Fiche", matches: "Card de la saison", career: "Saisons jouées", drills: "Entraînement quotidien", off: "Hors du clavier", languages: "Trois langues", contact: "Sifflet final" },
    ...
    projects: [
      ...
      { idx: "03", name: "MediSync", kanji: "癒", type: "Plateforme de santé", stack: "VUE.JS · SANTÉ", year: "2025-2026", opponent: "SUIVI COMPLEXE", verdict: "DONNÉES OBJECTIVES", desc: "Plateforme de santé connectée reliant l’observance médicamenteuse au vécu réel du patient pour offrir une prise en charge médicale personnalisée.", link: null, wip: true },
  ...
  en: {
    ...
    projects: [
      ...
      { idx: "03", name: "MediSync", kanji: "癒", type: "Health platform", stack: "VUE.JS · HEALTH", year: "2025-2026", opponent: "COMPLEX FOLLOW-UP", verdict: "OBJECTIVE DATA", desc: "Connected health platform linking medication adherence to the patient's real daily experience, to deliver personalised medical care.", link: null, wip: true },
  ...
  tr: {
    ...
    projects: [
      ...
      { idx: "03", name: "MediSync", kanji: "癒", type: "Sağlık platformu", stack: "VUE.JS · SAĞLIK", year: "2025-2026", opponent: "KARMAŞIK TAKİP", verdict: "OBJEKTİF VERİ", desc: "Kişiselleştirilmiş tıbbi bakım sunmak için ilaç uyumunu hastanın gerçek günlük deneyimiyle ilişkilendiren bağlantılı sağlık platformu.", link: null, wip: true },

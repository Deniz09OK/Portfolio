...
export const portfolio: Portfolio = {
  fr: {    nav: { roster: "Fiche", matches: "Card de la saison", career: "Saisons jouées", drills: "Entraînement quotidien", off: "Hors du clavier", languages: "Trois langues", contact: "Sifflet final" },
    ...
    projects: [
      { idx: "01", name: "AI-Morpion", kanji: "戦略", type: "Jeu · IA", stack: "PYTHON · MINIMAX · ALPHA-BETA", year: "2025", opponent: "JOUEUR HUMAIN", verdict: "IA INVINCIBLE", desc: "Version moderne du Tic-Tac-Toe avec une IA avancée utilisant l'algorithme Minimax. Élagage alpha-beta : l'IA ne perd jamais.", link: "https://github.com/Deniz09OK/AI-Morpion" },
      { idx: "02", name: "CultureQuiz", kanji: "知識", type: "App desktop", stack: "PYTHON · TKINTER · GUI", year: "2025", opponent: "ENNUI", verdict: "QUIZ INTERACTIF", desc: "Application de quiz interactif en Python avec interface Tkinter. Base de questions extensible, scoring, timer par manche.", link: "https://github.com/Deniz09OK/CultureQuiz" },
      { idx: "03", name: "EpiQuest", kanji: "冒険", type: "Jeu vidéo 2D", stack: "JAVA · LIBGDX · GAMEDEV", year: "2024", opponent: "MOTEUR VIDE", verdict: "PLATFORMEUR JOUABLE", desc: "Jeu d'aventure 2D développé avec Java et LibGDX. Système de combat, dialogues, progression. Projet équipe.", link: "https://github.com/Deniz09OK/Projet-Jeu-Java" },
      { idx: "04", name: "GoCrew", kanji: "旅", type: "Application web", stack: "JAVASCRIPT · WEB", year: "2025", opponent: "ORGANISATION CHAOTIQUE", verdict: "VOYAGE CENTRALISÉ", desc: "Application web collaborative (Pré-MSc Epitech). Centralise l’organisation de voyages en groupe dans une interface unique et intuitive.", link: "https://github.com/Deniz09OK/GoCrew" },
      ...
      { idx: "06", name: "MediSync", kanji: "癒", type: "Plateforme de santé", stack: "VUE.JS · SANTÉ", year: "2025", opponent: "SUIVI COMPLEXE", verdict: "DONNÉES OBJECTIVES", desc: "Plateforme de santé connectée reliant l'observance médicamenteuse au vécu réel du patient pour offrir une prise en charge médicale personnalisée.", link: "https://github.com/Deniz09OK/MediSync" },
      { idx: "07", name: "NSA — Network Security", kanji: "結界", type: "Infrastructure réseau", stack: "OPENBSD · FREEBSD", year: "2025", opponent: "RÉSEAU NON SEGMENTÉ", verdict: "PASSERELLE SÉCURISÉE", desc: "Infrastructure réseau sécurisée sous OpenBSD et FreeBSD. Configuration d'une passerelle segmentant trois réseaux privés.", link: null },
      { idx: "08", name: "Popeye", kanji: "船団", type: "Conteneurisation", stack: "DOCKER · MICROSERVICES", year: "2025", opponent: "MONOLITHE WEB", verdict: "ARCHITECTURE MODULAIRE", desc: "Projet de conteneurisation avec Docker. Application web complète en architecture microservices, communication inter-services et persistance.", link: "https://github.com/Deniz09OK/Popeye" },
      { idx: "09", name: "Portfolio", kanji: "書庫", type: "Site personnel", stack: "NUXT · VUE · TAILWIND", year: "2026", opponent: "PAGE BLANCHE", verdict: "VITRINE ÉVOLUTIVE", desc: "Refonte 2026 du portfolio. Design éditorial mêlant cybersécurité et culture sportive/japonaise. Storytelling au scroll, multilingue FR/EN/TR, dark & light, fiche joueur en hero.", link: "https://github.com/Deniz09OK/Portfolio" },
      { idx: "10", name: "Veille DevSecOps IA", kanji: "視", type: "Veille technologique", stack: "PYTHON · DEVSECOPS · IA", year: "2026", opponent: "FAILLES IGNORÉES", verdict: "SÉCURITÉ ANTICIPÉE", desc: "Ressources et scripts autour de l'intégration de l'Intelligence Artificielle dans les processus et la culture DevSecOps.", link: "https://github.com/Deniz09OK/veille-devsecops-ia" }
    ],
    career: {

...
export const portfolio: Portfolio = {
  fr: {    nav: { roster: "Fiche", matches: "Card de la saison", career: "Saisons jouées", drills: "Entraînement quotidien", off: "Hors du clavier", languages: "Trois langues", contact: "Sifflet final" },
    ...
    projects: [
      { idx: "01", name: "Veille DevSecOps IA", kanji: "視", type: "Veille technologique", stack: "PYTHON · DEVSECOPS · IA", year: "2026", opponent: "FAILLES IGNORÉES", verdict: "SÉCURITÉ ANTICIPÉE", desc: "Ressources et scripts autour de l'intégration de l'Intelligence Artificielle dans les processus et la culture DevSecOps.", link: "https://github.com/Deniz09OK/veille-devsecops-ia" },
      { idx: "02", name: "MediSync", kanji: "癒", type: "Plateforme de santé", stack: "VUE.JS · SANTÉ", year: "2025-2026", opponent: "SUIVI COMPLEXE", verdict: "DONNÉES OBJECTIVES", desc: "Plateforme de santé connectée reliant l'observance médicamenteuse au vécu réel du patient pour offrir une prise en charge médicale personnalisée.", link: "https://github.com/Deniz09OK/MediSync" },
      { idx: "03", name: "NSA — Network Security", kanji: "結界", type: "Infrastructure réseau", stack: "OPENBSD · FREEBSD", year: "2026", opponent: "RÉSEAU NON SEGMENTÉ", verdict: "PASSERELLE SÉCURISÉE", desc: "Infrastructure réseau sécurisée sous OpenBSD et FreeBSD. Configuration d'une passerelle segmentant trois réseaux privés.", link: null },
      { idx: "04", name: "Linux System Inventory", kanji: "監査", type: "Outil système", stack: "PYTHON · LINUX · VAGRANT", year: "2026", opponent: "PARC LINUX HÉTÉROGÈNE", verdict: "AUDIT AUTOMATISÉ", desc: "Outil d'inventaire système pour Linux automatisant la collecte d'informations matérielles et logicielles. Génère un rapport exploitable du parc.", link: "https://github.com/Deniz09OK/Linux-System-Inventory-Tool" },
      { idx: "05", name: "Portfolio", kanji: "書庫", type: "Site personnel", stack: "NUXT · VUE · TAILWIND", year: "2025-2026", opponent: "PAGE BLANCHE", verdict: "VITRINE ÉVOLUTIVE", desc: "Design éditorial mêlant cybersécurité et culture sportive/japonaise. Storytelling au scroll, multilingue FR/EN/TR, dark & light, fiche joueur en hero.", link: "https://github.com/Deniz09OK/Portfolio" },
      { idx: "06", name: "GoCrew", kanji: "旅", type: "Application web", stack: "JAVASCRIPT · WEB", year: "2025", opponent: "ORGANISATION CHAOTIQUE", verdict: "VOYAGE CENTRALISÉ", desc: "Application web collaborative (Pré-MSc Epitech). Centralise l’organisation de voyages en groupe dans une interface unique et intuitive.", link: "https://github.com/Deniz09OK/GoCrew" },
      { idx: "07", name: "AI-Morpion", kanji: "戦略", type: "Jeu · IA", stack: "PYTHON · MINIMAX · ALPHA-BETA", year: "2025", opponent: "JOUEUR HUMAIN", verdict: "IA INVINCIBLE", desc: "Version moderne du Tic-Tac-Toe avec une IA avancée utilisant l'algorithme Minimax. Élagage alpha-beta : l'IA ne perd jamais.", link: "https://github.com/Deniz09OK/AI-Morpion" },
      { idx: "08", name: "CultureQuiz", kanji: "知識", type: "App desktop", stack: "PYTHON · TKINTER · GUI", year: "2025", opponent: "ENNUI", verdict: "QUIZ INTERACTIF", desc: "Application de quiz interactif en Python avec interface Tkinter. Base de questions extensible, scoring, timer par manche.", link: "https://github.com/Deniz09OK/CultureQuiz" },
      { idx: "09", name: "Popeye", kanji: "船団", type: "Conteneurisation", stack: "DOCKER · MICROSERVICES", year: "2025", opponent: "MONOLITHE WEB", verdict: "ARCHITECTURE MODULAIRE", desc: "Projet de conteneurisation avec Docker. Application web complète en architecture microservices, communication inter-services et persistance.", link: "https://github.com/Deniz09OK/Popeye" },
  ...
  en: {
    ...
    projects: [
      { idx: "01", name: "AI-Morpion", kanji: "戦略", type: "Game · AI", stack: "PYTHON · MINIMAX · ALPHA-BETA", year: "2025", opponent: "HUMAN PLAYER", verdict: "UNBEATEN AI", desc: "Modern Tic-Tac-Toe with advanced AI using the Minimax algorithm. Alpha-beta pruning — the AI never loses.", link: "https://github.com/Deniz09OK/AI-Morpion" },
      { idx: "02", name: "CultureQuiz", kanji: "知識", type: "Desktop app", stack: "PYTHON · TKINTER · GUI", year: "2025", opponent: "BOREDOM", verdict: "INTERACTIVE QUIZ", desc: "Interactive Python quiz app with Tkinter interface. Extensible question base, scoring, round timer.", link: "https://github.com/Deniz09OK/CultureQuiz" },
      { idx: "03", name: "EpiQuest", kanji: "冒険", type: "2D video game", stack: "JAVA · LIBGDX · GAMEDEV", year: "2024", opponent: "EMPTY ENGINE", verdict: "PLAYABLE PLATFORMER", desc: "2D adventure game developed with Java and LibGDX. Combat system, dialogue, progression. Team project.", link: "https://github.com/Deniz09OK/Projet-Jeu-Java" },
      { idx: "04", name: "GoCrew", kanji: "旅", type: "Web application", stack: "JAVASCRIPT · WEB", year: "2025", opponent: "CHAOTIC PLANNING", verdict: "CENTRALIZED TRIP", desc: "Collaborative web app (Pre-MSc Epitech). Centralizes group travel organization in a single, intuitive interface.", link: "https://github.com/Deniz09OK/GoCrew" },
      { idx: "05", name: "Linux System Inventory", kanji: "監査", type: "System tool", stack: "PYTHON · LINUX · VAGRANT", year: "2026", opponent: "MIXED LINUX FLEET", verdict: "AUTOMATED AUDIT", desc: "Linux system inventory tool automating hardware and software information collection. Generates a usable fleet report.", link: "https://github.com/Deniz09OK/Linux-System-Inventory-Tool" },
      { idx: "06", name: "MediSync", kanji: "癒", type: "Health platform", stack: "VUE.JS · HEALTH", year: "2025", opponent: "COMPLEX FOLLOW-UP", verdict: "OBJECTIVE DATA", desc: "Connected health platform linking medication adherence to real patient experiences for personalized medical care.", link: "https://github.com/Deniz09OK/MediSync" },
      { idx: "07", name: "NSA — Network Security", kanji: "結界", type: "Network infra", stack: "OPENBSD · FREEBSD", year: "2025", opponent: "FLAT NETWORK", verdict: "SECURE GATEWAY", desc: "Secure network infrastructure on OpenBSD and FreeBSD. Gateway segmenting three private networks.", link: null },
      { idx: "08", name: "Popeye", kanji: "船団", type: "Containerization", stack: "DOCKER · MICROSERVICES", year: "2025", opponent: "WEB MONOLITH", verdict: "MODULAR ARCH.", desc: "Docker containerization project. Full web app in microservices architecture, inter-service comms and persistence.", link: "https://github.com/Deniz09OK/Popeye" },
      { idx: "09", name: "Portfolio", kanji: "書庫", type: "Personal site", stack: "NUXT · VUE · TAILWIND", year: "2026", opponent: "BLANK PAGE", verdict: "LIVING SHOWCASE", desc: "2026 redesign. Editorial design blending cybersecurity with sports/Japanese culture. Scroll storytelling, FR/EN/TR i18n, dark & light, player card hero.", link: "https://github.com/Deniz09OK/Portfolio" },
      { idx: "10", name: "Veille DevSecOps IA", kanji: "視", type: "Tech watch", stack: "PYTHON · DEVSECOPS · AI", year: "2026", opponent: "IGNORED FLAWS", verdict: "ANTICIPATED SECURITY", desc: "Resources and scripts focused on integrating Artificial Intelligence into DevSecOps processes and culture.", link: "https://github.com/Deniz09OK/veille-devsecops-ia" }
    ],
  ...
  tr: {
    ...
    projects: [
      { idx: "01", name: "AI-Morpion", kanji: "戦略", type: "Oyun · YZ", stack: "PYTHON · MINIMAX · ALPHA-BETA", year: "2025", opponent: "İNSAN OYUNCU", verdict: "YENİLMEZ YZ", desc: "Minimax algoritması kullanan gelişmiş YZ ile modern Tic-Tac-Toe. Alfa-beta budama — YZ asla kaybetmez.", link: "https://github.com/Deniz09OK/AI-Morpion" },
      { idx: "02", name: "CultureQuiz", kanji: "知識", type: "Masaüstü", stack: "PYTHON · TKINTER · GUI", year: "2025", opponent: "SIKINTI", verdict: "İNTERAKTİF QUIZ", desc: "Tkinter arayüzü ile Python'da interaktif bilgi yarışması uygulaması. Genişletilebilir soru tabanı, puanlama, tur zamanlayıcı.", link: "https://github.com/Deniz09OK/CultureQuiz" },
      { idx: "03", name: "EpiQuest", kanji: "冒険", type: "2D video oyunu", stack: "JAVA · LIBGDX · OYUN", year: "2024", opponent: "BOŞ MOTOR", verdict: "OYNANABİLİR PLATFORMER", desc: "Java ve LibGDX ile geliştirilmiş 2D macera oyunu. Savaş sistemi, diyalog, ilerleme. Takım projesi.", link: "https://github.com/Deniz09OK/Projet-Jeu-Java" },
      { idx: "04", name: "GoCrew", kanji: "旅", type: "Web uygulaması", stack: "JAVASCRIPT · WEB", year: "2025", opponent: "KAOTİK PLANLAMA", verdict: "MERKEZİ SEYAHAT", desc: "İşbirlikçi web uygulaması (Pre-MSc Epitech). Grup seyahat organizasyonunu tek ve sezgisel bir arayüzde toplar.", link: "https://github.com/Deniz09OK/GoCrew" },
      ...
      { idx: "06", name: "MediSync", kanji: "癒", type: "Sağlık platformu", stack: "VUE.JS · SAĞLIK", year: "2025", opponent: "KARMAŞIK TAKİP", verdict: "OBJEKTİF VERİ", desc: "Kişiselleştirilmiş tıbbi bakım sunmak için ilaç uyumunu hastanın gerçek deneyimleriyle birleştiren bağlantılı sağlık platformu.", link: "https://github.com/Deniz09OK/MediSync" },
      { idx: "07", name: "NSA — Network Security", kanji: "結界", type: "Ağ altyapısı", stack: "OPENBSD · FREEBSD", year: "2025", opponent: "DÜZ AĞ", verdict: "GÜVENLİ GEÇİT", desc: "OpenBSD ve FreeBSD üzerinde güvenli ağ altyapısı. Üç özel ağı segmentleyen ağ geçidi yapılandırması.", link: null },
      { idx: "08", name: "Popeye", kanji: "船団", type: "Konteynerleştirme", stack: "DOCKER · MİKROSERVİS", year: "2025", opponent: "WEB MONOLİT", verdict: "MODÜLER MİMARİ", desc: "Docker konteynerleştirme projesi. Mikroservis mimarisinde tam web uygulaması, servisler arası iletişim ve kalıcılık.", link: "https://github.com/Deniz09OK/Popeye" },
      { idx: "09", name: "Portfolio", kanji: "書庫", type: "Kişisel site", stack: "NUXT · VUE · TAILWIND", year: "2026", opponent: "BOŞ SAYFA", verdict: "YAŞAYAN VİTRİN", desc: "Portfolyonun 2026 yeniden tasarımı. Siber güvenlik ile spor/Japon kültürünü harmanlayan editöryel tasarım. Scroll storytelling, FR/EN/TR çoklu dil, koyu & açık, hero'da oyuncu kartı.", link: "https://github.com/Deniz09OK/Portfolio" },
      { idx: "10", name: "Veille DevSecOps IA", kanji: "視", type: "Teknoloji takibi", stack: "PYTHON · DEVSECOPS · YZ", year: "2026", opponent: "GÖZARDI EDİLEN AÇIKLAR", verdict: "ÖNGÖRÜLEN GÜVENLİK", desc: "Yapay Zekanın DevSecOps süreçlerine ve kültürüne entegrasyonu üzerine kaynaklar ve komut dosyaları.", link: "https://github.com/Deniz09OK/veille-devsecops-ia" }
    ],

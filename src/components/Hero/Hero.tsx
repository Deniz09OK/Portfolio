      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="hero-subtitle text-xl text-gray-600 mb-4">{t.jobTitle}</p>
            <div className="flex justify-center md:justify-start space-x-4 mb-8">
              <a href="https://github.com/Deniz09OK" target="_blank" rel="noopener noreferrer" title="GitHub Profile" className="text-gray-600 hover:text-red-600 transition-colors duration-300">
                <Github className="w-6 h-6 icon-spin" />
              </a>
              <a href="https://www.linkedin.com/in/deniz-ok" target="_blank" rel="noopener noreferrer" title="LinkedIn Profile" className="text-gray-600 hover:text-red-600 transition-colors duration-300">

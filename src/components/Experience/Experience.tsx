    ...
    <section id="experience" className="py-20 px-8 bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="experience-card bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
            <h3 className="text-xl font-bold text-gray-800 mb-2">{language === 'fr' ? t.computerRoomSetup : t.computerRoomSetup}</h3>
          ...
          <div className="experience-card bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
            <h3 className="text-xl font-bold text-gray-800 mb-2">{language === 'fr' ? t.itInternship : t.itInternship}</h3>
